...
const originalRoles: Roles = {
    ...
    courtier: {
        ...
        otherNight: 10,
        otherNightReminder:
            "Reduce the remaining number of days the marked player is drunk. If the Courtier has not yet used their ability: The Courtier either shows a 'no' head signal, or points to a character on the sheet. If the Courtier used their ability: If that character is in play, that player is drunk.",
        reminders: [
    ...
    acrobat: {
        ...
        otherNight: 39,
        otherNightReminder:
            "If the chosen player is drunk or poisoned, the Acrobat player dies.",
        reminders: [{ text: "Dead", count: 1 }],
        setup: false,
        ability:
    ...
    organgrinder: {
        ...
        team: "minion",
        firstNight: 17.1,
        firstNightReminder: "The Organ Grinder chooses if they are drunk.",
        otherNight: 7.1,
        otherNightReminder: "The Organ Grinder chooses if they are drunk.",
        reminders: [
